...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-pink-500 via-blue-500 to-white py-20 px-8 xs:px-12 relative flex flex-col">
      <div
      ...
      <div className="flex flex-col justify-center items-center flex-grow relative">
        ...
        <h1 className="text-4xl text-black font-extralight">
          I&apos;m{' '}
          <Link href="https://github.com/kiahjh" className="font-bold text-black">
            @kiahjh
          </Link>
        </h1>
